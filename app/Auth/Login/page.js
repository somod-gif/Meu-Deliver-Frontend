...
// Toast component with Toastify-like styling
const Toast = ({ message, type, onClose, progress }) => {
  return (
    <div className={`Toastify__toast Toastify__toast--${type}`}>
      ...
      <button className="Toastify__close-button" onClick={onClose}>
        ×
      </button>
      {progress && (
        <div 
          className="Toastify__progress-bar Toastify__progress-bar--animated"
