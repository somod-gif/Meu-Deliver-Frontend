...
export default function HomePage() {
  ...
  const HERO_IMG = 'https://thumbs.dreamstime.com/b/delivery-man-customer-door-can-use-web-banner-infographics-hero-images-flat-modern-vector-illustration-198679901.jpg'
  ...
  const testimonials = [
    {
      ...
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b442?w=60&h=60&fit=crop&crop=face",
    ...
    <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center px-6 lg:px-8 ">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <p className="text-sm text-gray-600 max-w-md mx-auto lg:mx-0">
              Meu Deliver brings everything you need — food, groceries, pharmacy, documents & parcels — right to your door in Angola.
            </p>
      ...
      <section className="bg-gray-50 py-6 sm:py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600 mb-4 sm:mb-6 text-sm">Shop from your favorite local stores</p>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            >
              <svg className="w-6 h-6 text-gray-600 group-hover:text-[#00b1a5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="text-center mb-8">
                ...
                <h4 className="font-bold text-black text-xl mt-4 mb-2">{currentTestimonial.name}</h4>
          ...
          <div className="text-center">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-3 md:grid-cols-3 gap-2 sm:gap-4 lg:gap-8 text-white">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl lg:text-3xl mb-1 sm:mb-2 lg:mb-3">📧</div>
                  <h4 className="font-bold text-xs sm:text-sm lg:text-lg mb-1 lg:mb-2">Email</h4>
                  <p className="text-white/80 text-xs sm:text-sm lg:text-base">hello@meudeliver.com</p>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl lg:text-3xl mb-1 sm:mb-2 lg:mb-3">📞</div>
                  <h4 className="font-bold text-xs sm:text-sm lg:text-lg mb-1 lg:mb-2">Phone</h4>
                  <p className="text-white/80 text-xs sm:text-sm lg:text-base">+234 (0) 800 DELIVER</p>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl lg:text-3xl mb-1 sm:mb-2 lg:mb-3">💬</div>
                  <h4 className="font-bold text-xs sm:text-sm lg:text-lg mb-1 lg:mb-2">Chat</h4>
                  <p className="text-white/80 text-xs sm:text-sm lg:text-base">24/7 Live Support</p>
                </div>
              </div>
            </div>
          </div>
