  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const [products, cats] = response;

        setCategories(cats.data || []);
        setProductsByCategory(products.data.productsByCategory || {});

        const allProductsArray = Object.values(products.data.productsByCategory || {}).flat();
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="relative overflow-hidden bg-gradient-to-r from-[#00b1a5] via-[#00b1a5] to-[#a3d900] py-16 sm:py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Curated collection of premium products that blend innovation,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 border border-gray-100">
          ...
          <div
            className={`grid gap-3 sm:gap-4 ${viewMode === "grid" ? "grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5" : "grid-cols-1"}`}
          >
              ...
              >
                <div className="relative aspect-square bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2 flex flex-col gap-1">
                    {product.badge && (
                      <span
                        className={`px-2 py-1 text-[10px] font-bold text-white rounded-full ${getBadgeColor(product.badge)}`}
                      >
                        {product.badge}
                      </span>
                    )}
